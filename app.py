...
def index():
    ...
    return render_template('index.html', utilisateurs=utilisateurs_paginated, page=page, total=len(utilisateurs), per_page=per_page)
...
def spotify_analytics():
    ...
    return render_template('spotify_analytics.html', total_songs=total_songs, total_users=total_users,
                           average_duration=average_duration, top_artists=top_artists)
